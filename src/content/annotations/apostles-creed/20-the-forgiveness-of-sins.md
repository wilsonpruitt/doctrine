...
phrase_slug: the-forgiveness-of-sins
order: 20
phrase_display: "the forgiveness of sins"

latin: "remissionem peccatorum"
latin_note: "remissionem — accusative of remissio, from re- (back) + mittere (to send): the sending-back, the release, the letting-go, the discharge of a debt. In Roman legal Latin, remissio is the technical term for the cancellation of an obligation. peccatorum — genitive plural of peccatum, sin, from peccare (to stumble, to fall short, to miss the mark)."
greek: "ἄφεσιν ἁμαρτιῶν"
greek_note: "aphesis — release, dismissal, sending-away, remission of debt. The same Greek word that the Septuagint uses for the Jubilee year of release (Lev. 25:10, Isa. 61:1) and that Luke 4:18 quotes when Jesus opens his ministry by reading from Isaiah in the Nazareth synagogue: aphesis to the captives. hamartia — literally a missing of the mark (archery term), the standard New Testament word for sin; etymologically connected to the Aramaic ḥôbâ, which means both 'sin' and 'debt.'"
...
related:
  - apostles-creed/and-was-crucified
