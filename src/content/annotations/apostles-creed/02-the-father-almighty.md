...
phrase_slug: the-father-almighty
order: 2
phrase_display: "the Father almighty"

latin: "Patrem omnipotentem"
latin_note: "Word order matters: Patrem (Father) comes first as the proper name of the First Person; omnipotentem (almighty) is the qualifier, not the primary identity. The Latin reverses the Greek Πατέρα παντοκράτορα where pantokrator is itself the substantive title (LXX usage)."
greek: "Πατέρα παντοκράτορα"
greek_note: "Pantokrator — literally 'ruler of all,' not strictly 'able to do anything.' The LXX uses it 180+ times to render Hebrew YHWH Sabaoth (Lord of hosts) and El Shaddai. The English 'almighty' has drifted toward the omnipotent-can-do-anything sense; the Greek word is closer to all-sovereign."

translations:
  - version: "Book of Common Prayer (1662)"
    text: "the Father almighty"
  - version: "ICET (1975)"
    text: "the Father, the Almighty"
  - version: "ELLC (1988)"
    text: "the Father almighty"
  ...
  - version: "UMC Hymnal (1989)"
    text: "the Father Almighty"
  - version: "Inclusive Language Lectionary (1983)"
    text: "the Father [and Mother] Almighty"
    note: "experimental, not widely adopted; representative of one strain of late-20th-century revision"
...
For congregations praying the creed, two pastoral wounds frequently sit under this clause: the abusive-father wound, where Father language reactivates harm, and the theodicy wound, where almighty rings hollow against a recent grief.

The pastoral honesty the creed asks for: it does not say what we want it to say. It does not say the Father is the loving father one wishes one had — though the gospel narrative discloses exactly that. It does not say almighty means God will prevent every suffering — though the eschatological hope is that God will finally end every suffering. The clause asks us to confess a particular God, on the terms God has given us, in the words the church has spoken for nearly two millennia.

What the pastor can say: the Father of Jesus Christ is not the projection of the believer's experience of human fathers, for good or ill. He is the Father who, in the gospel narrative, runs to the prodigal, weeps over Jerusalem, gives the Son up for the world. Whatever "Father" has meant in the believer's life, *this* is the Father we are confessing.

What the pastor can also say: the almighty Father is not the God who explains every grief. The almighty Father is the God who, in the Son, entered grief and, in the Spirit, accompanies the griever, and who, at the last, will wipe every tear away. The eschatological tense of the creed is load-bearing here. We confess the Father almighty in the certainty of what he will yet do, not in the easy assertion that all that is, is good.
