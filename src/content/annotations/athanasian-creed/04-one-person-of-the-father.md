...
section: the-trinity
phrase_slug: one-person-of-the-father
order: 4
phrase_display: "For there is one Person of the Father, another of the Son, and another of the Holy Spirit; but the Godhead of the Father, of the Son, and of the Holy Spirit is all one, the glory equal, the majesty coeternal."

latin: "Alia est enim persona Patris, alia Filii, alia Spiritus Sancti; sed Patris et Filii et Spiritus Sancti una est divinitas, aequalis gloria, coaeterna maiestas."
latin_note: "alia … alia … alia — 'one … another … another,' not 'first … second … third.' The creed deliberately refuses ordinal language: the persons are distinguished, never ranked. enim — 'for' — gives the positive ground of the prohibition in verse 4: do not confound the persons, for they are really distinct. sed — 'but' — pivots from the distinction to the unity. una est divinitas — 'the Godhead is one'; the creed now varies its term for the divine being (divinitas, where verse 4 had substantia), not from carelessness but to show the one reality under its several names. aequalis gloria — 'equal glory': aequalis is the anti-subordinationist keyword the rest of the creed will hammer. coaeterna maiestas — 'coeternal majesty': the co- compound (coaeternus, with its companion coaequalis) is Augustinian Trinitarian shorthand — together-eternal, no before or after among the persons. These two adjectives, aequalis and coaeterna, are introduced here and govern everything through verse 26."

translations:
  - version: "Book of Common Prayer (1662)"
    text: "For there is one Person of the Father, another of the Son, and another of the Holy Ghost. But the Godhead of the Father, of the Son, and of the Holy Ghost, is all one; the Glory equal, the Majesty coeternal."
  - version: "Book of Common Prayer (1979), Historical Documents"
    text: "For the Person of the Father is one; the Son, another; and the Holy Spirit, another. But the Godhead of the Father, of the Son, and of the Holy Spirit is one: the glory equal, the majesty coeternal."
  - version: "United Methodist use"
    text: "— (not received)"
    note: "the doctrine — distinct persons, one Godhead, equal glory, coeternal majesty — is the Methodist Articles of Religion, Article I: 'three persons, of one substance, power, and eternity.'"
