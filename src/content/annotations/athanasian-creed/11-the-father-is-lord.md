...
section: the-trinity
phrase_slug: the-father-is-lord
order: 11
phrase_display: "so likewise the Father is Lord, the Son Lord, the Holy Spirit Lord; and yet not three Lords, but one Lord."

latin: "Ita Dominus Pater, Dominus Filius, Dominus et Spiritus Sanctus. Et tamen non tres Domini, sed unus est Dominus."
latin_note: "Dominus — 'Lord,' the Latin for the Greek Κύριος (Kyrios). In the Septuagint Kyrios is the standard reverential substitute for the Tetragrammaton YHWH (read aloud as Adonai). So when the New Testament confesses Κύριος Ἰησοῦς, 'Jesus is Lord' (Romans 10:9; 1 Corinthians 12:3; Philippians 2:11), a Greek-Bible-shaped ear hears the divine Name laid on Jesus. Dominus Filius dogmatizes that confession. The verse is not redundant after verse 15's Deus: Deus names the divine nature (what God is); Dominus names the covenant Name and sovereign rule (who God is, by Name; that God reigns). non tres Domini, sed unus est Dominus — the creed again supplies the elided est, as at verse 16, marking the solemn close of the litany; unus Dominus echoes the Shema's Septuagint form, Κύριος εἷς ἐστιν (Deuteronomy 6:4), and 1 Corinthians 8:6 and Ephesians 4:5."

translations:
  - version: "Book of Common Prayer (1662)"
    text: "So likewise the Father is Lord, the Son Lord, and the Holy Ghost Lord. And yet not three Lords, but one Lord."
  - version: "Book of Common Prayer (1979), Historical Documents"
    text: "So likewise the Father is Lord, the Son Lord, and the Holy Spirit Lord. And yet there are not three lords, but one Lord."
  - version: "United Methodist use"
    text: "— (not received)"
    note: "the confession itself — 'Jesus is Lord' — is the church's oldest creed (Romans 10:9) and the daily substance of Methodist worship and hymnody, however the Quicumque went unrecited."
