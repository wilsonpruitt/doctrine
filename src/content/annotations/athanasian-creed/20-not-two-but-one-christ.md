...
translations:
  ...
  - version: "United Methodist use"
    text: "— (not received), kept verbatim in doctrine"
    note: "Methodist Articles of Religion, Article II: 'two whole and perfect natures … were joined together in one person, never to be divided, whereof is one Christ' — verses 34–37 word for word in substance."
